...
export default function Request({ onNavigate }: { onNavigate?: (p:string)=>void }) {
  ...
  return (
    <Layout activeNav="Request Monitoring" onNavigate={onNavigate} topbarTitle="Request Monitoring" searchPlaceholder="Quick search schedules..." userRole="Administrator">
