...
const EMPLOYEES = [
  { id:"#EMP-2840", name:"Johnathan Doe",  email:"j.doe@ovms-enterprise.com",     dept:"Production",    role:"Employee",         status:"ACTIVE",    lastLogin:"2 mins ago" },
  { id:"#EMP-2915", name:"Alina Smith",    email:"a.smith@ovms-enterprise.com",   dept:"FA",            role:"Employee",         status:"INACTIVE",  lastLogin:"3 days ago" },
  { id:"#EMP-3042", name:"Marcus Knight",  email:"m.knight@ovms-enterprise.com",  dept:"IT",            role:"Administrator",         status:"ACTIVE",    lastLogin:"1 hour ago" },
  { id:"#EMP-1102", name:"Robert Hanger",  email:"r.hanger@ovms-enterprise.com",  dept:"Driver",        role:"Driver",           status:"INACTIVE",  lastLogin:"Oct 12, 2023" },
  { id:"#EMP-4521", name:"Sarah Peters",   email:"s.peters@ovms-enterprise.com",  dept:"HRD & GA",      role:"Approver",         status:"ACTIVE",    lastLogin:"Online" },
];
...
export default function User({ onNavigate }: { onNavigate?: (p:string)=>void }) {
  ...
  return (
    <Layout activeNav="User Management" onNavigate={onNavigate} topbarTitle="User Management" searchPlaceholder="Quick search schedules..." userRole="Administrator">
        ...
        <div className="bg-white rounded-2xl border border-[#e2e8f0] shadow-sm overflow-hidden">
          <div className="px-5 py-4 border-b border-[#f1f5f9] flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <select value={deptFilter} onChange={e=>setDeptFilter(e.target.value)} className="h-8 px-3 bg-[#f8fafc] border border-[#e2e8f0] rounded-lg text-[12px] text-[#475569] focus:outline-none focus:ring-2 focus:ring-[#1e3a8a]/20">
                ...
                <tr key={e.id} className="border-t border-[#f1f5f9] hover:bg-[#f8fafc] transition-colors group">
                  ...
                  <td className="px-4 py-3.5 text-right">
                    <div className="flex gap-2 justify-end">
                      <button className="flex items-center gap-2 h-8 px-3 bg-white border border-[#e2e8f0] rounded-lg text-[12px] text-[#475569] hover:bg-[#f8fafc]"><Icon name="edit" className="text-[15px]" /></button>
                      <button className="flex items-center gap-2 h-8 px-3 bg-white border border-[#e2e8f0] rounded-lg text-[12px] text-[#dc2626] hover:bg-[#fee2e2]"><Icon name="delete" className="text-[15px]" /></button>
                    </div>
                  </td>
                </tr>
              ))}
